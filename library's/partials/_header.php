...
echo '
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark container-fluid fixed-top">
        <div class="container-fluid">';
            ...
            if($loggedin && $role == "editor"){
            echo '<a class="navbar-brand" href="/publiclibrary/editor/welcome.php">Public <img src="/publiclibrary/images/public_library.jpg" class = "rounded-circle" height = "23px" width = "23px" alt="library image"> Library</a>';               
            }
      ...
      echo '<button class="navbar-toggler" type="button" data-bs-toggle="collapse"
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              echo '<li class="nav-item">
                    ...
                    if($loggedin && $role == "editor"){
              echo '<li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/publiclibrary/editor/welcome.php">Home</a>
                    </li>';               
                    }
                    if($loggedin && $role == "admin"){
              echo '<li class="nav-item">
              ...
              echo '<li class="nav-item">
                ...
                if(!$loggedin){            
              echo '<a class="nav-link" href="/publiclibrary/user/welcome.php">
                ...
                if($loggedin){
              echo  '<a class="nav-link" href="/publiclibrary/editor/account.php">
                        <button class="btn btn-success mx-2"><img src="/publiclibrary/images/editor_profile.jpg" class="rounded-circle" height="19px" width="19px" alt="profile image"> '. $_SESSION['username'] .'</button>
                    </a>
                    <a class="nav-link" href="/publiclibrary/editor/logout.php">
