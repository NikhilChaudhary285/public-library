...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
        /*** Update/Reset Admin Account Password ***/
        // Variables
        ...
        if(($new_password == $confirm_password)){
            ...
            $sql = "UPDATE `libraryadmins` SET `password` = '$hash' WHERE `libraryadmins`.`emailid` = '$emailid'";
            $result = mysqli_query($conn, $sql);
            // Update/Reset Admin Account Password to the libraryadmins table in library database
            if ($result){
        ...
        <div class="card reset_card mx-auto">
            <div class="d-flex g-0">
                ...
                <div class="w-50 p-4 mx-auto shadow-lg bg-white rounded">
                    ...
                    <form action="/publiclibrary/admin/change-password.php" method="post">
