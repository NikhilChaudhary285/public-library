...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "Select * from `libraryeditors` where username='$username' OR emailid='$username'";
...
<head>
    ...
    <title>Log In - Public Library</title>
    <!-- Title Bar Icon -->
            ...
            <div class="d-flex g-0">
                ...
                <div class="w-50 p-4 mx-auto shadow-lg bg-white rounded">
                    ...
                    <div class="text-center my-2">
                        <span class="border py-1 px-2 fw-normal">Editor Login</span>
                    </div>
                    ...
                    <form action="/publiclibrary/editor/login.php" method="post">
                        <div class="mt-4">
                        ...
                        <div class="mt-4">
                            <div class="d-flex justify-content-between">
                                ...
                                <span class=""><a class="text-muted fs-14 forgot_password" href="/publiclibrary/editor/reset-password.php">Forgot Password?</a></span>
                            </div>
